defmodule LiveFilter.DateUtils do
  ...
  def parse_date_range({start_ndt, end_ndt}, timestamp_type) when is_struct(start_ndt, NaiveDateTime) do
  ...
  def parse_date_range(preset, timestamp_type) when is_binary(preset) do
    ...
    case preset do
      ...
      "this_year" ->
        convert_range_to_type({%{today | month: 1, day: 1}, %{today | month: 12, day: 31}}, timestamp_type)
  ...
  def convert_to_type(datetime, :datetime, _position) when is_struct(datetime, DateTime), do: datetime
  def convert_to_type(datetime, :utc_datetime, _position) when is_struct(datetime, DateTime), do: datetime
