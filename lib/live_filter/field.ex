...
defimpl LiveFilter.Field, for: Atom do
  ...
  def operators(:string), do: [:equals, :not_equals, :contains, :not_contains, :starts_with, :ends_with, :is_empty, :is_not_empty]
  def operators(:integer), do: [:equals, :not_equals, :greater_than, :less_than, :greater_than_or_equal, :less_than_or_equal, :between, :is_empty, :is_not_empty]
  def operators(:float), do: [:equals, :not_equals, :greater_than, :less_than, :greater_than_or_equal, :less_than_or_equal, :between, :is_empty, :is_not_empty]
  def operators(:boolean), do: [:is_true, :is_false, :equals]
  def operators(:date), do: [:equals, :before, :after, :on_or_before, :on_or_after, :between, :is_empty, :is_not_empty]
  def operators(:enum), do: [:equals, :not_equals, :in, :not_in, :is_empty, :is_not_empty]
  def operators(:array), do: [:contains_any, :contains_all, :not_contains_any, :is_empty, :is_not_empty]
