defmodule TodoAppUi do
  ...
  ### Server-Client Communication
      ...
      def handle_event("open_dialog", _params, socket) do
        socket = TodoAppUi.LiveView.send_command(socket, "user-dialog", "open")
        {:noreply, socket}
      end
  ...
  defmacro __using__(_) do
    quote do
      import TodoAppUi.Accordion
      import TodoAppUi.Alert
      import TodoAppUi.AlertDialog
      import TodoAppUi.Avatar
      import TodoAppUi.Badge
      import TodoAppUi.Breadcrumb
      import TodoAppUi.Button
      import TodoAppUi.Card
      import TodoAppUi.Chart
      import TodoAppUi.Checkbox
      import TodoAppUi.Collapsible
      import TodoAppUi.Dialog
      import TodoAppUi.DropdownMenu
      import TodoAppUi.Form
      import TodoAppUi.Helpers
      import TodoAppUi.HoverCard
      import TodoAppUi.Icon
      import TodoAppUi.Input
      import TodoAppUi.Label
      import TodoAppUi.Menu
      import TodoAppUi.Pagination
      import TodoAppUi.Popover
      import TodoAppUi.Progress
      import TodoAppUi.RadioGroup
      import TodoAppUi.ScrollArea
      import TodoAppUi.Select
      import TodoAppUi.Separator
      import TodoAppUi.Sheet
      import TodoAppUi.Sidebar
      import TodoAppUi.Skeleton
      import TodoAppUi.Slider
      import TodoAppUi.Switch
      import TodoAppUi.Table
      import TodoAppUi.Tabs
      import TodoAppUi.Textarea
      import TodoAppUi.Toggle
      import TodoAppUi.ToggleGroup
      import TodoAppUi.Tooltip
    end
  end
end
